...
# Packages
yay -S --noconfirm hyprland waybar wofi swww hyprlock cliphist xdg-desktop-portal-hyprland alacritty mpv pulsemixer grim slurp polkit-gnome nwg-look blueman fastfetch btop zoxide
...
yay -Rsc --noconfirm nano xterm unrar sysfsutils b43-fwcutter btrfs-progs ding-libs dosfstools ell eos-hooks f2fs-tools fd fzf sof-firmware smart-montools s-nail reflector rebuild-detector man-db man-pages modemmanager openvpn xl2tpd wildmidi xmlsec xfsprogs xdg-user-dirs usbutils tcl smartmontools sg3_utils reiserfsprogs plocate pcutils nilfs-utils mtools
